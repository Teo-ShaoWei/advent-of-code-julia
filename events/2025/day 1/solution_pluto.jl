...
# ╔═╡ 27fa11a9-657e-4382-9ed0-0a85df2da619
fldmod(-200, 100)

# ╔═╡ 97f36561-89ca-411c-9ac9-8b53e8b9b527
function passed_zeros(start_num, final_num)
	(start_group, start_rem) = fldmod(start_num, 100)
	(final_group, final_rem) = fldmod(final_num, 100)
	
	correction = 0
	if final_num < start_num
		(start_rem == 0) && (correction += 1)
		(final_rem == 0) && (correction -= 1)
	end
	
	return abs(final_group - start_group + correction)
end

# ╔═╡ 38cef4ac-b455-4c2e-8a38-eea141b9fba4
[
	passed_zeros(45, 104),
	passed_zeros(105, 45),
	passed_zeros(-45, -104),
...
# ╔═╡ 14aa74e6-98e3-40b7-abdc-b5fb720a45d4
[
	passed_zeros(-245, 0),
	passed_zeros(-145, 0),
	passed_zeros(-45, 0),
...
# ╔═╡ 5c9f0c17-aae6-4caa-b10c-e5b59c36791f
[
	passed_zeros(100, -100),
	passed_zeros(-100, 100),
]

# ╔═╡ 89443d7e-1dc7-48af-ae76-543556ad4513
[
	passed_zeros(0, -245),
	passed_zeros(0, -145),
	passed_zeros(0, -45),
...
function result2(pd)
	...
	zero_counter = 0
    for (; dir, mag) in pd
		new_x = (dir == :R) ? x + mag : x - mag
		zero_counter += passed_zeros(x, new_x)
		x = new_x
	end
	return zero_counter
end

...
# ╔═╡ cf80a1fd-0e5a-487d-af65-89d039be4ccf
using MD5
...
# ╔═╡ c9976074-8caa-4106-a505-96b5fa225447
function is_adventcoin(coin; pd, leading_zeros)
	@chain coin begin
		string
		pd * _
		md5
		bytes2hex
		_[1:leading_zeros] == repeat('0', leading_zeros)
	end
end

# ╔═╡ 07329eb0-4720-4997-896c-a6bd918735ba
is_adventcoin(609043; pd = "abcdef", leading_zeros = 5)

# ╔═╡ 291afd63-5514-4e19-87ca-31dfc8f6261e
function find_first_adventcoin(pd; leading_zeros, limit)
	@chain 1:limit begin
		(is_adventcoin(coin; pd, leading_zeros) for coin ∈ _)
		findfirst
	end
end
...
function result1(pd)
    find_first_adventcoin(pd; leading_zeros = 5, limit = 10^7)
end
...
function result2(pd)
	find_first_adventcoin(pd; leading_zeros = 6, limit = 10^7)
end

...
function split_role(directions::Vector{Symbol})
	[
		directions[1:2:end],
	 	directions[2:2:end],
	]
...
function get_direction(c::Symbol)
	(;
		> = CI( 1,  0),
		< = CI(-1,  0),
		^ = CI( 0,  1),
...
# ╔═╡ 021c62a9-a224-4a42-8869-71f16909add0
get_direction(:^)

# ╔═╡ cb8365e8-9082-42da-ae77-17869966dc9b
function get_travelled(v::Vector{Symbol})
	@chain v begin
		@. get_direction
		cumsum
		Set
